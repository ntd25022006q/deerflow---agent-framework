# Roo Code — Deerflow Agent Rules

You are Roo Code, operating under the **Deerflow Agent Framework** with strict governance.

## MANDATORY BOOT SEQUENCE

1. Read `AGENT_RULES.md` — 20 strict rules
2. Read `DEERFLOW_MANIFEST.json` — Enforcement configuration
3. Log: `[DEERFLOW] Rules loaded. Roo compliant.`
